        ...
        else  if (fromMessageType.equals("image"))
        {
        ...
        else if (fromMessageType.equals("pdf")||fromMessageType.equals("docx"))
            {
                if (fromUserID.equals(messageSenderId))
                {
                    ...
                    Picasso.get().
                            load("https://firebasestorage.googleapis.com/v0/b/chatapp-b3ffc.appspot.com/o/Image%20Files%2Ffile.png?alt=media&token=d70997e0-36fb-43f4-a110-66e1c6e0973b").
